...
<body>
  ...
  <a class="active" href="<?php echo $link2; ?>">Crop Price</a>
  ...
  <form class="modal-content animate" method="POST" action="">
    ...
    <div class="container">
      <h1>Crop price Finder </h1>
      <p></p>
      <hr>

      <img src="cropprice1.gif" width="1180" height="300">
      <hr>
      ...
      if(isset($_POST["Search"]))
       {
        $sqli1 = mysqli_query($conn,"select * from market where crop_name= '$_POST[cname]' ");
        
       while($row=mysqli_fetch_array($sqli1))
        {
          
          $CNAME=$row["crop_name"];
          $CPRICE=$row["crop_price"];
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<th>"; echo "Crop Price"; echo "</th>";
    echo "<td>"; echo $CPRICE; echo "</td>";
    echo "</tr>";
     echo"</table>";
    echo "</br>";
