...
<div class="topnav">
  ...
  <a class="active" href="">Suggesting Crop</a>
  ...
  <form class="modal-content animate" method="POST" action="suggestinsert.php">
    <div class="imgcontainer">
     
    <div class="container">
      <h1>Suggest Crops for Location</h1>
      <p>Please fill in this form .</p>
      <hr>
      <img src="loc2.gif" width="1180" height="300">
      <hr>
...
<form class="modal-content animate" method="POST" action="suggestupdate.php">
    <div class="imgcontainer">
     
    <div class="container">

 <h1>Update Suggested crop</h1>
      <p>Please fill in this form </p>
      <hr>
      <img src="locc2.jpg" width="1180" height="300">
      <hr>
